...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
         I am very fond of designing dynamic and imaginative products from the ground up. Focuses on the development of intuitive experiences, based on user metrics, which are constantly evolving and improving.{" "}
      </span>
    </h1>
  );
